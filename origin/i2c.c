...
ssize_t i2c_ioctl_write(const I2CDevice *device, unsigned int iaddr, unsigned char *buf, size_t len)
{
    ssize_t remain = len;
    size_t size = 0, cnt = 0;
...
*/
ssize_t i2c_write(const I2CDevice *device, unsigned int iaddr, unsigned char *buf, size_t len)
{
    ssize_t remain = len;
    ssize_t ret;
    size_t cnt = 0, size = 0;
